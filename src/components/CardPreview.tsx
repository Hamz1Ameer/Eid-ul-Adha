...
export default function CardPreview({
  ...
  const [revealedPrayers, setRevealedPrayers] = useState<
  ...
  const Lantern = ({ delay = 0, className = "" }) => (
    ...
    >
      {/* Lantern String */}
      <div
        className={`w-0.5 h-16 ${isLight ? "bg-amber-600/30" : "bg-amber-400/20"}`}
      />
      {/* Lantern Cap */}
      <svg
        viewBox="0 0 100 120"
        className={`w-10 h-12 fill-current ${theme.accentColor} filter drop-shadow`}
      >
        {/* Top loop */}
        <circle
          cx="50"
        ...
        {/* Dome */}
        <path
          d="M20,60 C20,35 50,25 50,25 C50,25 80,35 80,60"
          stroke="currentColor"
          strokeWidth="3"
        />
        {/* Glass body */}
        ...
        {!isOpen ? (
          ...
          >
            ...
            <div className="my-auto py-12 flex flex-col items-center gap-6 z-10 w-full">
              ...
              <div className="space-y-2">
                <h3
                  className={`text-xs uppercase tracking-widest ${isLight ? "text-amber-800" : "text-amber-400"} font-bold font-sans`}
                >
                  Blessed Greeting
                </h3>
                ...
                {recipient && (
                  <p
                    className={`text-sm mt-4 max-w-xs mx-auto ${isLight ? "text-amber-950/70" : "text-amber-200/80"} font-sans leading-relaxed`}
                  >
                    Dear{" "}
                    <span className="font-semibold text-amber-300">
                      {recipient}
                    </span>
                    , a personalized 3-part greeting has been created for you.
                  </p>
                )}
              </div>
            ...
            <p
              className={`text-[10px] ${isLight ? "text-amber-900/40" : "text-white/30"} uppercase tracking-wider`}
            >
          ...
          >
            ...
            <div className="absolute top-20 inset-x-8 flex justify-between pointer-events-none opacity-40">
              <svg
                className="w-4 h-4 fill-current text-amber-300 animate-pulse"
                viewBox="0 0 24 24"
              >
                <path d="M12 0l3 9 9 3-9 3-3 9-3-9-9-3 9-3z" />
              </svg>
              <svg
                className="w-5 h-5 fill-current text-yellow-300 animate-pulse delay-500"
                viewBox="0 0 24 24"
              ...
              <AnimatePresence mode="wait">
                {activeSlide === 0 && (
                  ...
                  >
                    <div>
                      <span
                        className={`text-[9px] uppercase tracking-widest ${isLight ? "text-amber-800/80" : "text-amber-400/80"} font-black`}
                      >
                        Message Slide 1 of 3
                      </span>
                      <h3
                        className={`text-xl sm:text-2xl font-serif font-bold mt-1 tracking-wide ${isLight ? "text-amber-900" : "text-amber-200"}`}
                      >
                        Sacred Invitation
                      </h3>
                    ...
                    <div className="my-auto py-2">
                      ...
                      >
                        <svg
                          viewBox="0 0 100 100"
                          className={`w-20 h-20 mx-auto fill-current ${theme.accentColor} drop-shadow-[0_0_12px_rgba(245,158,11,0.5)]`}
                        >
                          ...
                          <circle
                            ...
                            cy="30"
                            r="3"
                            className="fill-yellow-300 animate-ping"
                          />
                          <polygon
                            points="68,28 70,30 74,30 71,32 72,36 68,34 64,36 65,32 62,30 66,30"
                            className="fill-current text-amber-300 animate-pulse"
                          />
                        </svg>
                      </motion.div>
                    </div>
                    ...
                    <div className="space-y-4 max-w-xs sm:max-w-md">
                      {recipient && (
                        <p
                          className={`text-xs font-semibold uppercase tracking-wider ${isLight ? "text-amber-900" : "text-amber-300"}`}
                        >
                          To:{" "}
                      ...
                      <p
                        className={`text-[13px] sm:text-sm leading-relaxed px-4 italic font-sans ${isLight ? "text-amber-950/80" : "text-emerald-100/90"}`}
                      >
                        "{slide1Msg}"
                      </p>
                    </div>
                ...
                {activeSlide === 1 && (
                  ...
                  >
                    <div>
                      ...
                      {wish.arabic && (
                        <div
                          className={`text-lg sm:text-xl font-serif mt-1 tracking-widest opacity-80 ${isLight ? "text-amber-800" : "text-amber-300"}`}
                        >
                          {wish.arabic}
                        </div>
                      )}
                    ...
                    <div className="my-auto py-2 flex flex-col items-center">
                      <motion.div
                        ...
                        className="relative"
                      >
                        <svg viewBox="0 0 80 80" className="w-50 h-50 mx-auto">
                          {/* Fluffy body */}
                          <path
                          ...
                          {/* Curly horns */}
                          <path
                            d="M 31,23 C 27,21 23,24 25,27 L 27.5,26"
                            fill="none"
                            stroke="#d97706"
                            strokeWidth="2.5"
                            strokeLinecap="round"
                          />
                          <path
                            d="M 44,23 C 48,21 52,24 50,27 L 47.5,26"
                            fill="none"
                            stroke="#d97706"
                            strokeWidth="2.5"
                            strokeLinecap="round"
                          ...
                          <rect
                            ...
                            height="13"
                            rx="4"
                            fill={isLight ? "#1e293b" : "#022c22"}
                          />
                          <circle cx="36" cy="32" r="1.2" fill="#fff" />
                          <circle cx="42" cy="32" r="1.2" fill="#fff" />
                          <path
                            d="M 34,26 C 36,24.5 39,24.5 41,26 C 42.5,26.5 43,28 42,29 C 41,30 34,30 33,29 C 32,28 32.5,26.5 34,26 Z"
                            fill={isLight ? "#fbfbf8" : "#f0fdf4"}
                          />
                          <ellipse
                            cx="37.5"
                      ...
                      <span
                        className={`text-[8px] uppercase tracking-widest ${isLight ? "text-amber-800/40" : "text-amber-100/40"} font-mono`}
                      >
                        Eid Sacrifice motif
                      </span>
                    </div>
                    ...
                    <div className="space-y-3.5 max-w-xs sm:max-w-md">
                      <h1
                        className={`text-2xl font-bold font-display ${isLight ? "text-amber-900" : "text-amber-200"} tracking-tight`}
                      >
                        Al-Adha Mubarak
                      </h1>
                      <p
                ...
                {activeSlide === 2 && (
                  ...
                  >
                    <div>
                      ...
                      <h3
                        className={`text-xl font-serif font-bold mt-1 tracking-wide ${isLight ? "text-amber-900" : "text-amber-200"}`}
                      >
                        Sacred Devotions
                      </h3>
                      <div className="text-[10px] text-amber-500 font-serif opacity-80 mt-0.5">
                    ...
                    <div className="w-full max-w-[280px] sm:max-w-xs space-y-1.5 py-2">
                      <p
                        className={`text-[9px] uppercase tracking-widest ${isLight ? "text-stone-400" : "text-emerald-400/60"} mb-1`}
                      >
                      ...
                      {[
                        {
                          id: 1,
                          icon: "🕌",
                          label: "Barakah & Serenity",
                          desc: "May your home always find divine stillness and peaceful heartbeats.",
                        },
                        {
                          id: 2,
                          icon: "💖",
                          label: "Accepted Good Deeds",
                          desc: "May all your sacrifices, prayers, and charities be highly rewarded.",
                        },
                        {
                          id: 3,
                          icon: "🌟",
                          label: "Endless Health",
                          desc: "May physical strength and absolute content walk with you on all paths.",
                        },
                      ].map((p) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex-1 text-left leading-tight">
                              <p
                                className={`font-bold text-[11px] ${isRevealed ? "text-amber-300" : "text-emerald-100/85"}`}
                              >
                                {p.label}
                              </p>
                              <AnimatePresence>
                            ...
                            <span
                              className={`text-[9px] text-amber-400 font-bold self-start`}
                            >
                              {isRevealed ? "✓" : "Reveal"}
                            </span>
                          </motion.button>
                    ...
                    <div className="space-y-3 px-2 max-w-xs sm:max-w-md">
                      <p
                        className={`text-[12px] sm:text-xs leading-relaxed italic font-sans ${isLight ? "text-amber-950/80" : "text-emerald-100/90"}`}
                      >
                        "{slide3Msg}"
                      </p>
                      ...
                      {sender && (
                        <div
                          className={`pt-2 border-t ${isLight ? "border-amber-200/50" : "border-amber-400/10"}`}
                        >
                          <span
                            className={`text-[9px] uppercase tracking-wider ${isLight ? "text-amber-950/50" : "text-emerald-300/50"} block`}
                          >
                            With love & prayers from
                          </span>
                          <p
                            className={`text-xs font-bold ${isLight ? "text-amber-800" : "text-amber-300"} font-serif mt-0.5`}
                          >
                            {sender}
                          </p>
                        </div>
